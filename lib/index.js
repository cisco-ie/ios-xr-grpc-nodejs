...
xrGrpc.prototype.getConfig = function(reqId, yangPathJSON) {
	return this.xrGrpcClient.getConfig(this.msgs.ConfigGetArgs(reqId, yangPathJSON), this.params.metadata, this.params.options);
}
...
xrGrpc.prototype.mergeConfig = function(reqId, yangJSON) {
	return this.xrGrpcClient.mergeConfig(this.msgs.ConfigArgs(reqId, yangJSON), this.params.metadata, this.params.options);
}
...
xrGrpc.prototype.deleteConfig = function(reqId, yangJSON) {
	return this.xrGrpcClient.deleteConfig(this.msgs.ConfigArgs(reqId, yangJSON), this.params.metadata, this.params.options);
}
...
xrGrpc.prototype.replaceConfig = function(reqId, yangJSON) {
	return this.xrGrpcClient.replaceConfig(this.msgs.ConfigArgs(reqId, yangJSON), this.params.metadata, this.params.options);
}
...
xrGrpc.prototype.cliConfig = function(reqId, cli) {
	return this.xrGrpcClient.cliConfig(this.msgs.CliConfigArgs(reqId, cli), this.params.metadata, this.params.options);
}
...
xrGrpc.prototype.commitReplace = function(reqId, cli, yangJSON) {
	return this.xrGrpcClient.commitReplace(this.msgs.CommitReplaceArgs(reqId, cli, yangJSON), this.params.metadata, this.params.options);
}
...
xrGrpc.prototype.commitConfig = function(reqId, commitMsg) {
	return this.xrGrpcClient.commitConfig(this.msgs.CommitArgs(reqId, commitMsg), this.params.metadata, this.params.options);
}
...
xrGrpc.prototype.configDiscardChanges = function(reqId) {
	return this.xrGrpcClient.configDiscardChanges(this.msgs.DiscardChangesArgs(reqId), this.params.metadata, this.params.options);
}
...
xrGrpc.prototype.getOper = function(reqId, yangPathJSON) {
	return this.xrGrpcClient.getOper(this.msgs.GetOperArgs(reqId, yangPathJSON), this.params.metadata, this.params.options);
}
...
xrGrpc.prototype.showCmdTextOutput = function(reqId, cli) {
	return this.xrGrpcCliClient.showCmdTextOutput(this.msgs.ShowCmdArgs(reqId, cli), this.params.metadata, this.params.options);
}
...
xrGrpc.prototype.showCmdJSONOutput = function(reqId, cli) {
	return this.xrGrpcCliClient.showCmdJSONOutput(this.msgs.ShowCmdArgs(reqId, cli), this.params.metadata, this.params.options);
}
